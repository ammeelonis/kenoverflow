...
include_once('cms/includes/connection.php');
  ...
  $query = "SELECT * FROM products WHERE category = 'injectable'";
...
<body>
  <section class="menu1 cid-s2FqTl60XE" once="menu" id="menu1-o">
...
<section class="mbr-section shopfront3 content1 cid-trqr89RwkM" id="vegitarian-29">
  ...
  <div class="wrapper">
    ...
    <div class="col-md-6 col-sm-12 col-lg-3 cart-item">
                <div class="card p-3">
                    <div class="text-center"> <img src="assets/images/foto-nutrifer-200-b12-200x200.jpg" width="200" alt="" title=""> 
                  <input type="hidden" class="product-quantity" name="quantity" value="1" size="2">
                      <span class="product-code d-none">P017</span>
                  </div>
                    <div class="product-details"> <span class="font-weight-bold d-block">N 00.00</span> <span>Nutiri-Virall</span><div class="buttons d-flex flex-row">
               
                        <div class="weight"> <small>Lorem Ipsum</small> </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card p-3">
                    <div class="text-center"> <img src="assets/images/gentamox-200x200.jpg" width="200" alt="" title=""> 
                  <input type="hidden" class="product-quantity" name="quantity" value="1" size="2">
                      <span class="product-code d-none">P017</span>
                  </div>
                    <div class="product-details"> <span class="font-weight-bold d-block">N 00.00</span> <span>Gentamox</span><div class="buttons d-flex flex-row">
                ...
                <div class="card p-3">
                    <div class="text-center"> <img src="assets/images/nutridex-20-200x200.jpg" width="200" alt="" title=""> 
                  <input type="hidden" class="product-quantity" name="quantity" value="1" size="2">
                      <span class="product-code d-none">P017</span>
                  </div>
                    <div class="product-details"> <span class="font-weight-bold d-block">N 00.00</span> <span>Nutridex-20</span><div class="buttons d-flex flex-row">
                ...
                <div class="card p-3">
                    <div class="text-center"> <img src="assets/images/nutri-ivermec-200x200.jpg" width="200" alt="" title=""> 
                  <input type="hidden" class="product-quantity" name="quantity" value="1" size="2">
                      <span class="product-code d-none">P017</span>
                  </div>
                    <div class="product-details"> <span class="font-weight-bold d-block">N 00.00</span> <span>Nutri-Ivermec</span><div class="buttons d-flex flex-row">
                ...
                <div class="card p-3">
                    <div class="text-center"> <img src="assets/images/nutri-ivermec-super-200x200.jpg" width="200" alt="" title=""> 
                  <input type="hidden" class="product-quantity" name="quantity" value="1" size="2">
                      <span class="product-code d-none">P017</span>
                  </div>
                    <div class="product-details"> <span class="font-weight-bold d-block">N 00.00</span> <span>Nutri-Ivermec Super</span><div class="buttons d-flex flex-row">
                ...
                <div class="card p-3">
                    <div class="text-center"> <img src="assets/images/nutri-oxy-100-200x200.jpg" width="200" alt="" title=""> 
                  <input type="hidden" class="product-quantity" name="quantity" value="1" size="2">
                      <span class="product-code d-none">P017</span>
                  </div>
                    <div class="product-details"> <span class="font-weight-bold d-block">N 00.00</span> <span>Nutiri-Oxy 100</span><div class="buttons d-flex flex-row">
                ...
                <div class="card p-3">
                    <div class="text-center"> <img src="assets/images/nutri-oxy-200-la-200x200.jpg" width="200" alt="" title=""> 
                  <input type="hidden" class="product-quantity" name="quantity" value="1" size="2">
                      <span class="product-code d-none">P017</span>
                  </div>
                    <div class="product-details"> <span class="font-weight-bold d-block">N 00.00</span> <span>Nutiri-Oxy 200 LA</span><div class="buttons d-flex flex-row">
                ...
                <div class="card p-3">
                    <div class="text-center"> <img src="assets/images/nutri-penstrep-400-200x200.jpg" width="200" alt="" title=""> 
                  <input type="hidden" class="product-quantity" name="quantity" value="1" size="2">
                      <span class="product-code d-none">P017</span>
                  </div>
                    <div class="product-details"> <span class="font-weight-bold d-block">N 00.00</span> <span>Nutiri Penstrep-400</span><div class="buttons d-flex flex-row">
                ...
                <div class="card p-3">
                    <div class="text-center"> <img src="assets/images/nutrivit-200x200.jpg" width="200" alt="" title=""> 
                  <input type="hidden" class="product-quantity" name="quantity" value="1" size="2">
                      <span class="product-code d-none">P017</span>
                  </div>
                    <div class="product-details"> <span class="font-weight-bold d-block">N 00.00</span> <span>Nutirivit</span><div class="buttons d-flex flex-row">
