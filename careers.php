...
<body>
  <section class="menu1 cid-s2FqTl60XE" once="menu" id="menu1-g">
...
<section class="features1 conferencem4_features1 cid-t6L0h1bryU" id="features1-13">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-5 col-md-6 mbr-figure">
                <div class="image">
                    <img src="assets/images/pexels-lukas-669619-890x589.jpg" alt="" title="">
                </div>
            </div>
            <div class="col-lg-3 d-none d-lg-block mbr-figure">
                <div class="image2">
                    <img src="assets/images/pexels-tima-miroshnichenko-6235123-510x765.jpeg" alt="" title="">
                </div>
            </div>

            <div class="col-lg-4 col-md-6 content__block">
                
                <h2 class="mbr-section-title mbr-bold mbr-fonts-style display-5">Careers opportunities with Ken-Overflow</h2>
                <p class="mbr-text mbr-fonts-style display-4">We try to ensure the smooth running of our business, addressing/troubleshooting &nbsp;and escalating problems as they arise with a motivated, pro-active and dedicated team. Desire to work with us?</p>
                <div class="mbr-section-btn"><a class="btn btn-secondary display-4" href="mailto:careers@kenoverflow.com">Submit Application<span class="mobi-mbri mobi-mbri-right mbr-bold mbr-iconfont mbr-iconfont-btn"></span></a></div>
            </div>
        </div>
    </div>
</section>
