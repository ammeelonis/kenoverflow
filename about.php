...
<body>
  <section class="menu1 cid-s2FqTl60XE" once="menu" id="menu1-c">
...
<section class="header5 conferencem4_header5 cid-t351sfnUAH" id="header5-w">
    ...
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="mbr-figure col-lg-7">
                <div class="image">
                    <img src="assets/images/pexels-cottonbro-4919737-1748x2622.jpg" alt="" title="">
                </div>
            </div>
            <div class="col-lg-4 lg-push content__block text-white">
                <h3 class="mbr-section-subtitle  mbr-fonts-style display-4">About Us</h3>
                <h1 class="mbr-section-title mbr-bold mbr-fonts-style display-1">Comprehensive Veterinary Services in Nigeria</h1>
                <p class="mbr-text mbr-fonts-style display-4">Ken-Overflow Nig Ltd, is a wholly indigenous Nigerian Company. We came into existence in 2019, and are presently the sole Nigerian distributor for Nutrivet BV; an offshore GMP veterinary products manufacturer based in Holland. 
<br>
<br>Our Company is engaged in wholesale distribution of Veterinary Pharmaceuticals, Biologicals and other Animal Health Products. We also provide farmers with technical support services in the poultry, livestock and aquaculture sector across Nigeria; to contribute towards our national agricultural growth which accounts the highest for our National GDP.
<br>
<br>We have a broad distributorship base with professional sales representatives as qualified Veterinarians spearheading our marketing drive in all Geo-Political zones of the country. As a team, we also work with other industry based professionals to achieve our organizational goals.
<br>
<br>We are committed to providing veterinary products of very high and outstanding quality in the poultry, livestock and aquaculture industry. 
<br>
<br>Our CEO, is a young, energetic and very well experienced Veterinarian who is fully committed in serving the nation with his wealth of knowledge gleaned from home and abroad.&nbsp;<br></p>
