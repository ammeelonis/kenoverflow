...
include_once('cms/includes/connection.php');
  ...
  $query = "SELECT * FROM products WHERE category = 'oral'";
...
<body>
  <section class="menu1 cid-s2FqTl60XE" once="menu" id="menu1-m">
...
<section class="mbr-section shopfront3 content1 cid-trmx0g5INP" id="vegitarian-21">
    ...
    <h3 class="h3">Orals</h3>
      ...
      <!--  <div class="row g-1">
        ...
        <div class="col-md-6 col-sm-12 col-lg-3 cart-item">
                <div class="card p-3">
                    <div class="text-center"> <img src="assets/images/nutriflox200-400x400.png" width="200" alt="" title=""> 
                  <input type="hidden" class="product-quantity" name="quantity" value="1" size="2">
                      <span class="product-code d-none">P017</span>
                  </div>
                    <div class="product-details"> <span class="font-weight-bold d-block">N2,300</span> <span>NUTRIFLOX-200 ORAL - 100ml</span><br><span style="font-size: 12.8px; background-color: transparent; color: rgb(226, 222, 222);">Enrofloxacin 200mg; 20% Oral Solution. &nbsp;</span><span style="background-color: transparent; color: rgb(226, 222, 222); font-size: 12.8px;">Dilution ratio: 1 ml to 4 litres of water.</span>
                    </div>
                </div>
            </div><div class="col-md-6 col-sm-12 col-lg-3 cart-item">
                <div class="card p-3">
                    <div class="text-center"> <img src="assets/images/nutriflox200-400x400.jpg" width="200" alt="" title=""> 
                  <input type="hidden" class="product-quantity" name="quantity" value="1" size="2">
                      <span class="product-code d-none">P018</span>
                  </div>
                    <div class="product-details"> <span class="font-weight-bold d-block">N 16,666.67</span> <span>NUTRIFLOX-200 ORAL - 1000ml</span><span><br></span><span style="font-size: 12.8px; background-color: transparent; color: rgb(226, 222, 222);">Enrofloxacin 200mg; 20% Oral Solution. &nbsp;</span><span style="background-color: transparent; color: rgb(226, 222, 222); font-size: 12.8px;">Dilution ratio: 1 litre to 4,000 litres of water.</span>
                    </div>
                </div>
            </div><div class="col-md-6 col-sm-12 col-lg-3 cart-item">
                <div class="card p-3">
                    <div class="text-center"> <img src="assets/images/nutricipro200-400x400.png" width="200" alt="" title=""> 
                  <input type="hidden" class="product-quantity" name="quantity" value="1" size="2">
                      <span class="product-code d-none">P019</span>
                  </div>
                    <div class="product-details"> <span class="font-weight-bold d-block">N 2,583.34</span> <span>NUTRICIPRO-200 ORAL - 100ml</span><span><br></span><span style="font-size: 12.8px; background-color: transparent; color: rgb(226, 222, 222);">Ciprofloxacin 200mg; 20% Oral Solution. &nbsp;</span><span style="background-color: transparent; color: rgb(226, 222, 222); font-size: 12.8px;">Dilution ratio: 1 ml to 4 litres of water.</span>
                    </div>
                </div>
            </div><div class="col-md-6 col-sm-12 col-lg-3 cart-item">
                <div class="card p-3">
                    <div class="text-center"> <img src="assets/images/nutricipro200-big-400x400.png" width="200" alt="" title=""> 
                  <input type="hidden" class="product-quantity" name="quantity" value="1" size="2">
                      <span class="product-code d-none">P020</span>
                  </div>
                    <div class="product-details"> <span class="font-weight-bold d-block">N 20,750.00</span> <span>NUTRICIPRO-200 ORAL - 1000ml</span><span><br></span><span style="font-size: 12.8px; background-color: transparent; color: rgb(226, 222, 222);">Ciprofloxacin 200mg; 20% Oral Solution. &nbsp;</span><span style="background-color: transparent; color: rgb(226, 222, 222); font-size: 12.8px;">Dilution ratio: 1 litre to 4,000 litres of water.</span>
                    </div>
                </div>
            </div><div class="col-md-6 col-sm-12 col-lg-3 cart-item">
                <div class="card p-3">
                    <div class="text-center"> <img src="assets/images/ciprostar-20-400x400.png" width="200" alt="" title=""> 
                  <input type="hidden" class="product-quantity" name="quantity" value="1" size="2">
                      <span class="product-code d-none">P020</span>
                  </div>
                    <div class="product-details"> <span class="font-weight-bold d-block">N 2,500.00</span> CIPROSTAR 20% ORAL - 100ml<br><span style="background-color: transparent; color: rgb(226, 222, 222); font-size: 12.8px;">Ciprofloxacin 200mg: 20% Oral Solution.</span>
                    </div>
                </div>
            </div><div class="col-md-6 col-sm-12 col-lg-3 cart-item">
                <div class="card p-3">
                    <div class="text-center"> <img src="assets/images/nutriflor100-oral-400x400.png" width="200" alt="" title=""> 
                  <input type="hidden" class="product-quantity" name="quantity" value="1" size="2">
                      <span class="product-code d-none">P020</span>
                  </div>
                    <div class="product-details"> <span class="font-weight-bold d-block">N 2,466.67</span> <span>NUTRIFLOR-100 ORAL - 100ml</span><span><br></span><span style="font-size: 12.8px; background-color: transparent; color: rgb(226, 222, 222);">Florfenicol 100mg; 10% Oral Solution. &nbsp;</span><span style="background-color: transparent; color: rgb(226, 222, 222); font-size: 12.8px;">Dilution ratio: 1 ml to 1 litre of water.</span>
                    </div>
                </div>
            </div><div class="col-md-6 col-sm-12 col-lg-3 cart-item">
                <div class="card p-3">
                    <div class="text-center"> <img src="assets/images/nutricoxoral-400x400.png" width="200" alt="" title=""> 
                  <input type="hidden" class="product-quantity" name="quantity" value="1" size="2">
                      <span class="product-code d-none">P020</span>
                  </div>
                    <div class="product-details"> <span class="font-weight-bold d-block">N 2,416.67</span> <span>NUTRICOX ORAL - 100ml</span><span><br></span><span style="font-size: 12.8px; background-color: transparent; color: rgb(226, 222, 222);">Toltrazuril 25mg Oral Solution.&nbsp;</span><span style="background-color: transparent; color: rgb(226, 222, 222); font-size: 12.8px;">Dilution ratio: 1 ml to 1 litre of water.</span>
                    </div>
                </div>
            </div><div class="col-md-6 col-sm-12 col-lg-3 cart-item">
                <div class="card p-3">
                    <div class="text-center"> <img src="assets/images/nutricoxoralbig-400x400.png" width="200" alt="" title=""> 
                  <input type="hidden" class="product-quantity" name="quantity" value="1" size="2">
                      <span class="product-code d-none">P020</span>
                  </div>
                    <div class="product-details"> <span class="font-weight-bold d-block">N 18,083.34</span> <span>NUTRICOX ORAL - 1000ml</span><span><br></span><span style="font-size: 12.8px; background-color: transparent; color: rgb(226, 222, 222);">Toltrazuril 25mg Oral Solution. &nbsp;</span><span style="background-color: transparent; color: rgb(226, 222, 222); font-size: 12.8px;">Dilution ratio: 1 litre to 1,000 litres of water.</span>
                    </div>
                </div>
            </div><div class="col-md-6 col-sm-12 col-lg-3 cart-item">
                <div class="card p-3">
                    <div class="text-center"> <img src="assets/images/nutristressoral-400x400.png" width="200" alt="" title=""> 
                  <input type="hidden" class="product-quantity" name="quantity" value="1" size="2">
                      <span class="product-code d-none">P020</span>
                  </div>
                    <div class="product-details"> <span class="font-weight-bold d-block">N 6,916.67</span> <span>NUTRISTRESS ORAL - 1000ml</span><span><br></span><span style="font-size: 12.8px; background-color: transparent; color: rgb(226, 222, 222);">Higly concentrated Vitamins, Minerals &amp; Amino acids Oral Solution.&nbsp;</span><span style="background-color: transparent; color: rgb(226, 222, 222); font-size: 12.8px;">Dilution ratio: 1 litre to 2,000 litres of water.</span>
                    </div>
                </div>
            </div><div class="col-md-6 col-sm-12 col-lg-3 cart-item">
                <div class="card p-3">
                    <div class="text-center"> <img src="assets/images/nutriaminooral-400x400.png" width="200" alt="" title=""> 
                  <input type="hidden" class="product-quantity" name="quantity" value="1" size="2">
                      <span class="product-code d-none">P020</span>
                  </div>
                    <div class="product-details"> <span class="font-weight-bold d-block">N 7,250.00</span> <span>NUTRIAMINO ORAL - 1000ml</span><span><br></span><span style="font-size: 12.8px; background-color: transparent; color: rgb(226, 222, 222);">Essential Amino acids preparation.&nbsp;</span><span style="background-color: transparent; color: rgb(226, 222, 222); font-size: 12.8px;">Dilution ratio: 1 litre to 4,000 litres of water.</span>
                    </div>
                </div>
            </div></div>-->
    </div>
