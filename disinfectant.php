...
include_once('cms/includes/connection.php');
  ...
  $query = "SELECT * FROM products WHERE category = 'disinfectant'";
...
<section class="mbr-section shopfront3 content1 cid-t6KZLRq4IS" id="vegitarian-z">
  ...
  <div class="wrapper">
    ...
    <div class="col-md-6 col-sm-12 col-lg-3 cart-item">
                <div class="card p-3">
                    <div class="text-center"> <img src="assets/images/25l-jerrycan-200x200.jpg" width="200" alt="" title=""> 
                  <input type="hidden" class="product-quantity" name="quantity" value="1" size="2">
                    ...
                    <div class="product-details"> <span class="font-weight-bold d-block">N 00.00</span> <span>Nutiri-Virall</span><div class="buttons d-flex flex-row">
                        ...
                        <div class="weight"><font color="#e2dede"><span style="font-size: 12.8px;">Lorem Ipsum</span></font></div>
                    </div>
                </div>
            </div>
